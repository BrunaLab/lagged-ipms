...
<!--# should  mention starting population vector here.  Observed population could be a reasonable starting point.  Emphasize that choice of starting vector should only impact transient dynamics, which we're not interested in here. -->

To calculate 95% confidence intervals around the per-capita growth rates (lambdas), we created 1000 bootstraps of the 10 year demographic dataset by sampling individual plants with replacement within each habitat.
...
Similar to @kayeEffectStochasticTechnique2003 finding that method effected stochastic lambda, but relative ranking of populations was consistent.
