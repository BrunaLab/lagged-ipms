...
```{r aic, results='asis'}
pandoc.table(
  tar_read(aic_tbl_df) %>% rename("edf" = "df"),
...
```{r lifecycle}
#| fig.cap = "Lifecycle diagram of IPMs with equations.  Diagram shows equations for the deterministic IPM and the table shows how the equations differ in the other two IPM types."
