...
2.  It has long been recognized that there is the potential for lagged effects.
    Including lagged effects in models has been a major technical challenge, but there are now multiple approaches for doing so.
    The studies assessing the potential for lagged effects on vital rates find that they indeed appear to be prevalent [@eversLaggedDormantSeason2021; @scottDelayedEffectsClimate2022].
