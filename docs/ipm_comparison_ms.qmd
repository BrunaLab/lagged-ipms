...
Environmental conditions influence demographic vital rates, but there is increasing evidence that changes in vital rates can be delayed months or even years. These *Lagged Effects*, also known as *Delayed Life-history Events*, can simultaneously affect an entire cohort or only a subset of the population. Moreover, the temporal delay between an environmental event and the resulting changes in demographic vital rates may depend on both the intensity of the event and its timing relative to the underlying physiological mechanisms. Because lagged effects are often directly linked to reproduction and survival, it has been argued they could have major but underappreciated consequences for population dynamics. There have been few tests of this hypothesis, however, in part because the statistical methods for incorporating lagged effects in structured population models have only recently been developed. We parameterized three classes of Integral Projection Models --- deterministic, stochastic, and stochastic with lagged effects of precipitation on vital rates --- using census data from populations of a Amazonian understory herb. We used these models to determine (1) if incorporating lagged effects altered projections of population growth rate, and (2) if habitat-specific differences in lagged effects translate into habitat-specific projections of population growth rate (i.e., $\lambda$). Projections of $\lambda$ were significantly lower when models included lagged effects. These models also resulted in more variable projections of population structure, both within and across habitats. These differences could be critical in conservation or management settings, where even small differences in $\lambda$ can have major short-term consequences for population dynamics.
...
<!-- COMMENTED OUT BELOW FOR 2X-BLIND SUBMISSION -->
